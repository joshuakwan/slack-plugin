...
public class SlackNotifierTest extends TestCase {
	...
	public SlackNotifierTest(SlackServiceStub slackServiceStub,
			boolean response, FormValidation.Kind expectedResult) {
	...
	public void testDoTestConnection() {
		...
		try {
			FormValidation result = descriptor.doTestConnection("teamDomain",
					"authToken", "room", "buildServerUrl", "BuildServerNick",
					true, "obfuscatorUrl", "obfuscatorToken");
